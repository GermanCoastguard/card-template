...
// // <button class="scroll-to-paragraph-top-button"> scroll to top</button>
...
// <button class="scroll-to-paragraph-bottom-button"> scroll to bottom</button>
...
*/
// <button class="scroll-to-card-top-button"> scroll to top</button>

function scrollToCardTop(btn) {
    let container = btn.parentElement;
    while (!container.classList.contains('card-container')) {
        container = container.parentNode;
    }
    container.scrollIntoView({ behavior: 'smooth', block: 'start' });
...
// <button class="scroll-to-card-bottom-button"> scroll to bottom</button>
